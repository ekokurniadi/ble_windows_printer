...
abstract class RustNative {
  ...
  Future<void> mouseCursor({required int x, required int y, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kMouseCursorConstMeta;
}
...
class RustNativeImpl implements RustNative {
  final RustNativePlatform _platform;
  factory RustNativeImpl(ExternalLibrary dylib) =>
      RustNativeImpl.raw(RustNativePlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory RustNativeImpl.wasm(FutureOr<WasmModule> module) =>
      RustNativeImpl(module as ExternalLibrary);
  RustNativeImpl.raw(this._platform);
  Future<String> invokeMethod({required MethodChannel channel, dynamic hint}) {
  ...
  Future<void> mouseCursor({required int x, required int y, dynamic hint}) {
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_mouse_cursor(port_, arg0, arg1),
      parseSuccessData: _wire2api_unit,
      constMeta: kMouseCursorConstMeta,
      argValues: [x, y],
      hint: hint,
    ));
  }
...
class RustNativePlatform extends FlutterRustBridgeBase<RustNativeWire> {
  RustNativePlatform(ffi.DynamicLibrary dylib) : super(RustNativeWire(dylib));
...
class RustNativeWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  RustNativeWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  RustNativeWire.fromLookup(
  ...
  void wire_mouse_cursor(
    int port_,
    int x,
    int y,
  ) {
    return _wire_mouse_cursor(
      port_,
      x,
      y,
    );
  ...
  late final _wire_mouse_cursorPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64, ffi.Int32, ffi.Int32)>>('wire_mouse_cursor');
  late final _wire_mouse_cursor =
      _wire_mouse_cursorPtr.asFunction<void Function(int, int, int)>();
